...
const verifyToken = (req, res) => {
     try{
          ...
          var challenge = req.body["hub.challenge"]; // es lo que debemos devolver al Whatsapp una vez que verificamos  que el token que nos da Whatsapp igual al token que hemos construido.
